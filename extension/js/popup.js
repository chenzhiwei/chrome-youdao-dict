...
/* harmony import */ var _style_popup_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(44);
/* harmony import */ var _style_popup_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_style_popup_scss__WEBPACK_IMPORTED_MODULE_1__);
...
var Popup = /*#__PURE__*/function () {
  ...
  _createClass(Popup, null, [{
    ...
    value: function renderResult(resultJson) {
      resultWrapper.innerHTML = __webpack_require__(46)(resultJson);
      Popup.audioPlay();
      Popup.addToWordBook();
      Popup.displayMore();
    }
    ...
    key: "processInput",
    value: function processInput(queryInput) {
      var _ref = [Popup.keyfrom, Popup.key, 'json', window.getSelection().toString().trim()],
          appKey = _ref[0],
          appSecret = _ref[1],
          resType = _ref[2],
          query = _ref[3];
      ...
      var youdao = new _util_youdao__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"](appKey, appSecret, resType, query);
    ...
    value: function audioPlay() {
      var audioAction = document.querySelector('#wav');
    ...
    value: function addToWordBook() {
      ...
      if (addToWordBookAction) {
        addToWordBookAction.addEventListener('click', function (ev) {
          ...
          _util_youdao__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].addToWordBook(word).then(function (res) {
            if (res.added) {
    ...
    value: function displayMore() {
      var moreAction = document.querySelector('#more');

      if (moreAction) {
        var moreUrl = moreAction.getAttribute('data-more');
        moreAction.addEventListener('click', function (ev) {
          ev.preventDefault();
...
_defineProperty(Popup, "keyfrom", 'your-youdao-appKey');

_defineProperty(Popup, "key", 'appSecret');
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body{min-width:450px;background:#FAFAFA;font-size:16px;font-family:\"Microsoft Yahei\", \"Monaco\", sans-serif}body input{font-size:1.5rem !important}body .clearfix:before,body .clearfix:after{display:table;content:''}body .clearfix:after{clear:both}body .pull-left{float:left}body .pull-right{float:right}body .queryBox{margin-bottom:0}body .queryBox .dictForm{margin-bottom:0}body .queryBox .dictForm>.row{margin-bottom:0}body .queryBox .dictForm>.row>.input-field{margin-top:0.5rem}body .resultBox{margin-bottom:5px}body .resultBox .resultField{padding:10px}body .resultBox .resultField .basic{display:block;margin-bottom:0.5rem;font-size:1.3rem;line-height:inherit}body .resultBox .resultField .basic .pronoun{display:block;margin-bottom:0.3rem;font-style:italic}body .resultBox .resultField .basic .pronoun #wav{padding:0 5px}body .resultBox .card-action{padding:10px 20px}body .resultBox .card-action span{margin-right:5px;padding:0;transition:0.3s ease;text-transform:uppercase;color:#ffab40;cursor:pointer}body .resultBox .card-action span:hover,body .resultBox .card-action span:active{color:#ffd8a6;outline:0}body .resultBox .card-action .spinner{display:inline-block;position:relative;margin:0 5px;width:20px;height:20px}body .resultBox .card-action .spinner.hide{display:none}body .resultBox .card-action .spinner .double-bounce1,body .resultBox .card-action .spinner .double-bounce2{width:100%;height:100%;border-radius:50%;background-color:#ffab40;opacity:0.6;position:absolute;top:0;left:0;-webkit-animation:sk-bounce 2.0s infinite ease-in-out;animation:sk-bounce 2.0s infinite ease-in-out}body .resultBox .card-action .spinner .double-bounce2{-webkit-animation-delay:-1.0s;animation-delay:-1.0s}@-webkit-keyframes sk-bounce{0%,100%{-webkit-transform:scale(0)}50%{-webkit-transform:scale(1)}}@keyframes sk-bounce{0%,100%{transform:scale(0);-webkit-transform:scale(0)}50%{transform:scale(1);-webkit-transform:scale(1)}}\n", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;
    ...
    (function (Array, error, explains, loading, pronoun, relate, wav, word, wordReg, wordbook) {
      if (loading) {
pug_html = pug_html + "\u003Cdiv class=\"loading row\"\u003E\u003Cdiv class=\"col s12\"\u003E\u003Cdiv class=\"progress\"\u003E\u003Cdiv class=\"indeterminate\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
}
else {
pug_html = pug_html + "\u003Cdiv class=\"resultBox row\"\u003E\u003Cdiv class=\"col s12\"\u003E\u003Cdiv class=\"card blue-grey darken-1\"\u003E\u003Cdiv class=\"resultField card-content white-text\"\u003E\u003Cspan class=\"basic card-title\"\u003E";
if (error) {
pug_html = pug_html + (pug.escape(null == (pug_interp = error) ? "" : pug_interp));
}
else {
if (pronoun) {
pug_html = pug_html + "\u003Ccode class=\"pronoun\"\u003E\u002F" + (pug.escape(null == (pug_interp = pronoun) ? "" : pug_interp)) + "\u002F";
if (wav) {
pug_html = pug_html + "\u003Ca id=\"wav\" href=\"javascript:;\"\u003E";
...
pug_mixins["audio"]();
pug_html = pug_html + "\u003C\u002Fa\u003E\u003Caudio" + (" id=\"audio\" style=\"display: none;\""+pug.attr("src", `${wav}`, true, true)) + "\u003E\u003C\u002Faudio\u003E";
}
...
pug_html = pug_html + (pug.escape(null == (pug_interp = explain) ? "" : pug_interp)) + "\u003Cbr\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + (pug.escape(null == (pug_interp = explains) ? "" : pug_interp));
}
}
}
...
pug_html = pug_html + "\u003Cp class=\"web-translation\"\u003E" + (pug.escape(null == (pug_interp = r.key) ? "" : pug_interp)) + ":&nbsp;";
if (r.value) {
}
pug_html = pug_html + (pug.escape(null == (pug_interp = r.value) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"card-action clearfix\"\u003E";
var wordReg = /^\b[a-zA-Z0-9]+\b$/ig;
if (wordReg.test(word) && wordbook) {
pug_html = pug_html + "\u003Cspan" + (" class=\"pull-left\""+" id=\"addToWordBook\""+pug.attr("data-word", `${word}`, true, true)) + "\u003E添加到有道单词本\u003C\u002Fspan\u003E";
...
pug_html = pug_html + "\u003Cspan" + (" class=\"pull-right\""+" id=\"more\""+pug.attr("data-more", `https://dict.youdao.com/search?q=${word}`, true, true)) + "\u003Emore \u003E\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
}
    }.call(this, "Array" in locals_for_with ?
        locals_for_with.Array :
        typeof Array !== 'undefined' ? Array : undefined, "error" in locals_for_with ?
        locals_for_with.error :
        typeof error !== 'undefined' ? error : undefined, "explains" in locals_for_with ?
